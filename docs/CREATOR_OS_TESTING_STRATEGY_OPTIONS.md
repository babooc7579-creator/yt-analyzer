...
- 2026-07-14 최신 기준 `npm.cmd test`는 테스트 파일 196개, 테스트 841개가 통과합니다. 캘린더에서 제작 후보 한 건을 찾는 화면 의도, 홈 레이더 빈 상태의 다음 행동, 영상 카드의 게시일·경과일·후보 이유·주요 행동 순서도 hook, utility, component 렌더링 테스트에 포함됩니다.
