...
- 2026-07-03 UI 문구 안정화 2차 작업을 완료했습니다. 제작 후보함, 발견함, 홈, 채널 목록에서 Cloud 저장/삭제/상태 변경/YouTube API 호출 여부를 더 명확히 안내합니다.
...
1. 배포된 앱에서 핵심 화면을 짧게 확인합니다. 홈, 채널 목록, 발견함, 제작 후보함에서 새 문구가 의도대로 보이는지 확인하는 smoke입니다. 새 API 호출이나 DB 변경을 만들지 않습니다.
