...
- 현재 상태: 2026-07-06 사용자 승인 후 `vitest`와 `test: vitest run` 스크립트를 추가했고, 순수 함수 테스트 178개를 작성했습니다. GitHub Actions는 아직 `npm run build`만 실행합니다.
