...
11. `CREATOR_OS_VIDEO_RECORDS_SCHEMA_OPTIONS.md`
...
12. `CREATOR_OS_VIDEO_RECORDS_LONG_TERM_MODEL.md`
...
13. `CREATOR_OS_LOCAL_STORAGE_CLOUD_SYNC_OPTIONS.md`
...
14. `CREATOR_OS_NEXT_IMPLEMENTATION_ISSUES.md`
...
1. 제작 후보와 제작 칸반의 데이터 기준을 결정합니다.
2. discovery links 구현 전 저장 위치와 상태값을 사용자에게 선택지로 보고합니다.
