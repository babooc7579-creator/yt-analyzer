    ...
    <section aria-labelledby="collected-channel-reaction-title" className="border border-cyan-500/20 bg-cyan-500/5 p-4">
      <div>
        ...
        <p className="mt-1 text-xs leading-5 text-slate-400">
          현재 불러온 레퍼런스 채널의 저장 영상에서 반복·채널 확산·최근 등장·조회 반응을 비교한 상대 점수입니다.
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        {suggestions.map((suggestion) => (
          <button
            ...
            title={`${suggestion.label}: 수집 채널 반응도 ${suggestion.reactionScore}점, 저장 영상 ${suggestion.count}개, 채널 ${suggestion.channelCount}개에서 확인했습니다. 선택하면 현재 저장 영상 안에서 검색하며 API 호출이나 저장은 없습니다.`}
          >
