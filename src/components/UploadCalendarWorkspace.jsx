...
import { getUploadCalendarEmptyState } from '../utils/uploadCalendar';
...
export default function UploadCalendarWorkspace({ onOpenProductionCandidates, videoUserRecords, videos }) {
      ...
      <div className="mt-5 space-y-4">
        ...
        {emptyState ? (
          ...
          <>
            ...
            <UploadCalendarDayDetails items={state.selectedDayItems} onOpenProductionCandidates={onOpenProductionCandidates} selectedDate={state.selectedDate} />
          </>
        )}
      </div>
    </section>
