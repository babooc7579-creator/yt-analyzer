...
import { Bookmark, ExternalLink, Play, Rocket, Star, TrendingUp } from 'lucide-react';
    ...
    <div className="mt-6 rounded-2xl border border-rose-400/20 bg-rose-500/10 p-5">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-xs text-rose-100/70">현재 불러온 영상에서 터또터 가능성과 반응 강도를 기준으로 먼저 볼 3개를 골랐습니다.</p>
        </div>
