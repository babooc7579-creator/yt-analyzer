...
const videoWorkflowMocks = vi.hoisted(() => {
  const reviewWorkflow = {
    ...
    retryScrapbookSync: vi.fn(),
    retryVideoUserRecordsSync: vi.fn(),
...
describe('useCreatorAppVideoWorkflow', () => {
  ...
  it('combines video review, explorer state, and selection tools', () => {
    ...
    expect(workflow).toEqual({
      ...
      quickFilter: videoWorkflowMocks.explorerState.quickFilter,
      ...
      productionSourceVideos: videoWorkflowMocks.reviewWorkflow.productionSourceVideos,
      ...
      retryScrapbookSync: videoWorkflowMocks.reviewWorkflow.retryScrapbookSync,
      retryVideoUserRecordsSync: videoWorkflowMocks.reviewWorkflow.retryVideoUserRecordsSync,
      ...
      setQuickFilter: videoWorkflowMocks.explorerState.setQuickFilter,
