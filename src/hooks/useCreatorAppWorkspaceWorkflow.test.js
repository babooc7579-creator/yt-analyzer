...
const workspaceMocks = vi.hoisted(() => {
  ...
  const navigation = {
    ...
    setHasUnsavedWorkToolSettings: vi.fn(),
...
describe('useCreatorAppWorkspaceWorkflow', () => {
  ...
  it('combines navigation, discovery links, and top comment tools', () => {
    ...
    expect(workflow).toEqual({
      ...
      hasUnsavedWorkToolSettings: workspaceMocks.navigation.hasUnsavedWorkToolSettings,
      ...
      isRecentScanStatusView: workspaceMocks.navigation.isRecentScanStatusView,
      ...
      setHasUnsavedWorkToolSettings: workspaceMocks.navigation.setHasUnsavedWorkToolSettings,
