...
export const PRODUCTION_KANBAN_COLUMNS = [
  {
    ...
    emptyDescription: '레이더, 저장 영상, 발견함에서 만들 만한 항목을 제작 후보로 보내면 여기에 쌓입니다.',
  ...
  },
  {
    ...
    emptyDescription: '후보를 고른 뒤 제작 중으로 옮기면 지금 만드는 콘텐츠를 따로 볼 수 있습니다.',
  ...
  },
  {
    ...
    emptyDescription: '제작이 끝난 항목을 업로드 완료로 옮기면 완료 기록으로 남습니다.',
