export const VIDEO_RECORDS_SYNC_WARNINGS = {
  loadFallback: '온라인 저장소(Azure DB) 연결 실패로 이 브라우저에 남아 있던 영상 판단 임시 기록을 표시 중입니다. 이 기록은 온라인 저장소 기준 데이터가 아닙니다.',
...
export const SYNC_WARNING_BANNER_COPY = {
  ...
  helpText: '온라인 저장소 조회가 성공하면 해당 응답만 기준으로 사용합니다. 브라우저 임시 기록은 연결 실패 때만 표시합니다. 온라인 데이터와 자동 병합하거나 자동 업로드하지 않습니다.',
};
