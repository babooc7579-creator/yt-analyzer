...
export const CREATOR_OS_IMPROVEMENT_AREAS = [
  ...
  },
  {
    ...
    nextAction: '검색 영상→발견 링크→제작 후보→대본 작업실의 동일 원본 계약과 기존 후보의 바로가기를 자동 테스트로 고정했습니다. 다음은 운영에서 기존 제작 후보 링크의 후보함→대본 작업실 이동을 저장 없이 확인하고, 발견 링크 실제 저장 왕복은 검수 대상을 정한 뒤 별도로 실행합니다.',
    decisions: [
