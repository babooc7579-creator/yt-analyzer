...
export const CREATOR_OS_IMPROVEMENT_AREAS = [
  ...
  },
  {
    ...
    decisions: [
      ...
      '쇼츠 후보 중 제목·설명에 Shorts 표기가 있으면 `가능성 높음`, 없으면 `확인 필요`로만 구분하며 어느 경우도 확정 쇼츠로 자동 판정하지 않습니다.',
      ...
      '이미 제작 후보인 발견 링크도 발견 링크함에서 후보함의 해당 한 건으로 바로 이동할 수 있게 하고, 이동만으로 API 호출이나 저장을 실행하지 않습니다.',
    ],
    checkpoints: [
      {
      ...
      {
        id: 'youtube-search-shorts-confidence',
        label: '제목·설명 Shorts 표기 기반 가능성 구분·화면 필터·원본 최종 확인 동선',
        status: IMPROVEMENT_CHECKPOINT_STATUS.DONE,
      },
      {
      ...
      {
        id: 'discovery-candidate-script-continuity',
        label: '검색 영상의 발견 링크 저장 정보·제작 후보 링크 ID·대본 원본 ID 연속성과 기존 후보 바로가기',
        status: IMPROVEMENT_CHECKPOINT_STATUS.DONE,
      },
      {
