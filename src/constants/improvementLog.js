...
export const CREATOR_OS_IMPROVEMENT_AREAS = [
  ...
  },
  {
    ...
    nextAction: 'PR #1096 배포 후 운영 1,912px 화면에서 수집 영상 목록 H2 1개, 영상 검토 보드 H3 1개, 작업 순서 기본 접힘과 콘솔 오류 없음을 확인했습니다. 실제 모바일 기기 표시와 자연 발생 0개 채널 안내는 사용 중 해당 조건이 생길 때 확인하며, 다음 개선은 실제 목록 검토 중 발견하는 불편을 우선합니다.',
    decisions: [
