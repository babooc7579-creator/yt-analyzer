...
export const CREATOR_OS_IMPROVEMENT_AREAS = [
  ...
  },
  {
    ...
    nextAction: 'PR #1094 배포 후 운영 1,912px 화면에서 주 작업 영역 964px·새 영상 수집 352px와 가로 넘침 없음·콘솔 오류 없음을 확인했습니다. 실제 모바일 기기 표시와 자연 발생 0개 채널 안내는 사용 중 해당 조건이 생길 때 확인하며, 다음 개선은 사용자가 실제 목록을 검토하면서 발견하는 불편을 우선합니다.',
    decisions: [
