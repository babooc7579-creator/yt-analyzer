...
export const CREATOR_OS_IMPROVEMENT_AREAS = [
  ...
  },
  {
    ...
    nextAction: 'PR #1098 배포 후 TechByTosh의 Azure DB 영상 정보 95개를 다시 조회해 화면 이동 뒤 채널별 95개·최근 30일 4개·오래된 인기 3개·또터또 9개가 유지되고 조회 전 표시가 사라진 것을 확인했습니다. 다음은 실제 카드의 판단 정보 우선순위와 소재 보관·제작 후보 결과 위치를 점검합니다.',
    decisions: [
