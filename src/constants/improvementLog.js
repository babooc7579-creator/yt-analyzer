...
export const CREATOR_OS_IMPROVEMENT_AREAS = [
  ...
  },
  {
    ...
    nextAction: '카드 판단 정보 간소화 배포 후 운영 수집 영상 목록에서 일반 영상의 반복 상자 제거, 후보의 검토 이유 한 줄, 두 버튼의 결과 위치 안내를 확인합니다. 이후 실제 휴대폰과 자연 발생 0개 채널을 사용 중 확인하고 채널 태그별 보기의 메뉴 중복 여부를 점검합니다.',
    decisions: [
