...
export const CREATOR_OS_IMPROVEMENT_AREAS = [
  ...
  },
  {
    ...
    nextAction: '배포 후 영상·채널 검색에서 외부 관심도 도구와 Google Trends 검색 지역이 정확히 이어지는지 운영 화면에서 확인합니다. 앱 내부 급상승 자동 판정은 실제 시계열 데이터가 없으므로 구현된 것처럼 표시하지 않습니다. 실제 다음 25개 YouTube API 호출 검수는 첫 검색을 포함해 별도 명시적 실행으로 남깁니다.',
    decisions: [
