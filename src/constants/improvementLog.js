...
export const CREATOR_OS_IMPROVEMENT_AREAS = [
  ...
  },
  {
    ...
    nextAction: 'Mike Tholfsen의 Azure DB 수집 영상 250개 중 화면 기준 또터또 후보 44개를 추가 API 호출 없이 검토합니다. 먼저 추천순 상위 후보를 학습 자료와 제작 소재로 구분하고, 나머지 4개 채널의 실제 수집은 사용자가 다음 채널을 고른 뒤 1개씩 명시적으로 실행합니다.',
    decisions: [
      ...
      '비슷한 주제 1차 묶음은 제목 핵심어 겹침만 화면에서 계산하고, 결과 대부분에 반복되는 공통어와 일반 형식어는 제외합니다. 원본 영상·Azure DB 기록을 합치거나 AI·YouTube API를 호출하지 않습니다.',
    ],
    checkpoints: [
      {
