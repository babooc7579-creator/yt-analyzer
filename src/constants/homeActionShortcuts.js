export const HOME_ACTION_SHORTCUTS = [
  ...
  },
  {
    ...
    dataFlowLabels: ['Cloud DB 조회', '새 API 호출 없음'],
    iconName: 'bookmark',
...
export const HOME_WORKSPACE_SHORTCUTS = [
  {
    ...
    title: '키워드 탐색',
    description: '현재 불러온 Cloud 저장 영상에서 제목과 채널명으로 소재 단어를 찾습니다.',
    hint: '저장 영상 안에서 소재 검색',
  ...
  },
  {
    key: 'tag-vault',
    title: '태그별 금고',
    description: '기존 채널 태그로 채널을 묶고, 필요한 범위의 Cloud 저장 영상을 확인합니다.',
