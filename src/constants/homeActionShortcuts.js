export const HOME_ACTION_SHORTCUTS = [
  {
    ...
    hint: '채널 등록 화면 열기',
    dataFlowLabels: ['Cloud 채널 저장', '영상 수집 없음'],
    iconName: 'plus',
  ...
  },
  {
    ...
    dataFlowLabels: ['YouTube API 가능', 'Cloud 영상 갱신 가능'],
    iconName: 'refresh',
...
export const HOME_WORKSPACE_SHORTCUTS = [
  ...
  },
  {
    key: 'upload-calendar',
    title: '업로드 캘린더',
    description: 'Cloud 제작 기록에 저장된 목표 업로드 날짜를 달력에서 확인합니다.',
    hint: '제작 후보 일정 달력 열기',
    dataFlowLabels: ['Cloud 일정 조회', '데이터 변경 없음'],
    iconName: 'calendar',
