  ...
  return [
    {
      ...
      title: '오늘 볼 채널 고르기',
      value: channelsLoading ? '온라인 저장소(Azure DB) 조회 중' : selectedChannels > 0 ? `${selectedChannels}개 선택` : '선택 필요',
    ...
    },
    {
      ...
      title: '수집 영상 목록 불러오기',
      value: emptyLoad ? '수집 영상 0개' : loadedVideos > 0 ? `${loadedVideos}개 준비` : '온라인 저장소(Azure DB) 조회',
      hint: '수집된 영상 정보만 조회하며 새 수집은 하지 않습니다.',
      status: loadStatus,
      warning: emptyLoad,
    },
    {
