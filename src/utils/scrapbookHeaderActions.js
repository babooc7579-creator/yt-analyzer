  ...
  return {
    copyUrlButtonProps: {
      ...
      title: hasSavedVideos
        ? '스크랩 영상 제목과 YouTube URL 목록을 클립보드에 복사합니다. YouTube API 호출이나 저장 작업은 없습니다.'
        : '스크랩북에 보관한 영상이 있어야 URL 목록을 복사할 수 있습니다',
    ...
    promptButtonProps: {
      ...
      title: hasSavedVideos
        ? 'AI API를 호출하지 않고 스크랩 영상 기반 요청문만 클립보드에 복사'
        : '스크랩북에 보관한 영상이 있어야 복사할 수 있습니다',
